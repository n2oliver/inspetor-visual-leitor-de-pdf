...
const reader = {
    listarPaginas: async (totalPages) => {
    ...
    exibirLeitorDePDF: async function () {
    ...
    run: function () {
        ...
        window.addEventListener('load', async () => {
            ...
            window.focus();
            window.addEventListener("keydown", this.eventos);
